...
_G.packer_plugins = {
  ...
  ["null-ls.nvim"] = {
    loaded = true,
    path = "/Users/joshkennedy/.local/share/nvim/site/pack/packer/start/null-ls.nvim",
  ...
  ["vim-polyglot"] = {
    loaded = true,
    path = "/Users/joshkennedy/.local/share/nvim/site/pack/packer/start/vim-polyglot",
