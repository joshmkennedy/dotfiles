...
vim.keymap.set('v', 'aa', function() require 'align'.align_to_char({length=1}) end, NS)             -- Aligns to 1 character, looking left
vim.keymap.set('v', 'as', function() require 'align'.align_to_char({preview=true, length=2}) end, NS)       -- Aligns to 2 characters, looking left and with previews
